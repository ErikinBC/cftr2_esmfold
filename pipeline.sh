...
echo "--- (7) Adjust for AminoAcid Length with NW-estimator ---"
python3 7_debias_y.py

echo "--- (8) Run ML model to predict adjusted labels ---"
python3 8_predict_y.py

echo "--- (9) Generate summary stats and figures ---"
python3 9_summary_stats.py
